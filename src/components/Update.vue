...
<div class="container text-center">
    ...
    <div class="container all_form">
        <form ref="anyName" @submit.prevent="postData" method="post">
            ...
            <button type="submit" @click="updateData" class="btn btn-dark">
...
export default {
    ...
    validations() {
       ...
       methods: {
        async updateData() {
            ...
            let result = await axios.put(
                "http://localhost:3001/user/" + this.$route.params.id, {
                    ...
                    cpassword: this.posts.cpassword,
                }
        ...
        async postData(e) {
            ...
            console.log("hello", this.v$);
            this.v$.$validate()
            if (!this.v$.$error) {
                // alert("Form successfully submitted")
                const result = await axios.post("http://localhost:3001/user", this.posts);
    ...
    async mounted() {
        ...
        // const result = await axios.get("http://localhost:3001/user/2");
        const result = await axios.get("http://localhost:3001/user/" + this.$route.params.id );
                // console.log(result);
